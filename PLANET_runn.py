...
class PlanetEstimator():
    def __init__(self,device):
        ...
        self.model.load_parameters('PLANET.param') # 确保参数加载到指定设备
...
def workflow(protein_pdb,mol_file,ligand_sdf=None,centeriod_x=None,centeriod_y=None,centeriod_z=None):
    ...
    estimator = PlanetEstimator(device) # Pass the CPU device
    estimator.model.to(device) # Ensure the model is on the CPU device
